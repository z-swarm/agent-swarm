...
- `CHANGELOG.md` 新增 W36a 节点 (DoD/数据/差距/Act 段)
- `docs/MEMORY.md` 新增 W36a 经验 (SecretRef 协议 + 轮换 cache 模式 + SecretManager 注入风格)
- 本地 `docs/P5-RETRO.md` (untrack) W36a 段
- 不开 tag (W36a 是 P5 中间切片, 0.5.0a2 时再批量打)
