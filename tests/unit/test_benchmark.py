...
pytestmark = pytest.mark.skipif(
    sys.platform == "win32",
    reason="P3-WIN: benchmark CLI smoke tests have Windows shell differences",
)
...
def test_compare_baseline_blocks_on_severe_regression() -> None:
    ...
    bl = {
        "G-X": {
            "duration_seconds": {"p50": 100},
            "total_tokens": {"p50": 100},
            "quality_score": {"min": 0.5},
        }
    }
