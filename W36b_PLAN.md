...
- `CHANGELOG.md` 新增 W36b 节点 (DoD/数据/差距/Act 段)
- `docs/MEMORY.md` 新增 W36b 经验 (UI 触发 review 模式 + HTMX 表单 + 写路径鉴权复用)
- 本地 `docs/P5-RETRO.md` (untrack) W36b 段
- 不开 tag (W36b 是 P5 中间切片, 0.5.0a2 时再批量打)
