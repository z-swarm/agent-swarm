...
- `CHANGELOG.md` 新增 W36c 节点 (DoD/数据/差距/Act 段)
- `docs/MEMORY.md` 新增 W36c 经验 (vault:// 协议 + field 提取 + URI scheme 扩展模式)
- 本地 `docs/P5-RETRO.md` (untrack) W36c 段
- 不开 tag (W36c 是 P5 中间切片, 0.5.0a2 时再批量打)
